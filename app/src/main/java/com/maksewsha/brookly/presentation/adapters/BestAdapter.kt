...
class BestAdapter(private val best: List<BestPresentation>): RecyclerView.Adapter<BestAdapter.BestViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BestViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.best_card, parent, false)
